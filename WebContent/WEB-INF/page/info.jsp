    ...
    <script type="text/javascript">
        ...
        wx.ready(function () {
            wx.onMenuShareAppMessage({
                title: '巾帼园万人相亲大会',
                desc: '巾帼园万人相亲大会！',
                link: 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx1c0b240b67b3873e&redirect_uri=http://yue.wishworks.cn/index.html&response_type=code&scope=snsapi_base&state=123&connect_redirect=1#wechat_redirect',
                imgUrl: 'http://yue.wishworks.cn/themes/img/logo.png',
                success: function () {
                     alert('已转发');
                },
                cancel: function () {
